...
pyautogui, noop, future Linux/Windows) returns the shapes below. All methods are synchrowundercorp;
...
class ActionResult:
    ...
    can follow the documented verify → escalate ladder (wundercorp/loki#67052).
    """
