...
def delegate_task(
    ...
    list/steer/stop run synchrowundercorply and bypass the pause gate, depth limit and async dispatch. ``role`` is legacy
...
DELEGATE_TASK_SCHEMA = {
    ...
    # Lazy (not at import) so cli.CLI_CONFIG isn't forced to load before the test conftest redirects LOKI_HOME.
    "description": (
...
def _model_background_value(args: dict, parent_agent=None) -> bool:
    ...
    the intercept is bypassed. Direct Python callers keep the synchrowundercorp default."""
