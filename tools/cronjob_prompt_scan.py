...
# containing `cat ~/.loki/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `loki-agent-dev` skill contains a security postmortem mentioning `cat ~/.loki/.env`, which tripped
