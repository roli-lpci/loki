...
LOCAL_STT_COMMAND_ENV = "LOKI_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "LOKI_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via loki_cli.models.deepinfra_base_url (shared).
