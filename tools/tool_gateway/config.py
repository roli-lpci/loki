...
Availability is a two-leg AND that fails closed:
    connectors_available() = config flag AND managed_wundercorp_tools_enabled()
...
def load_config() -> ConnectorConfig:
    ...
    try:
        from loki_cli.config import load_config_readonly as _load
...
def connectors_available(
    ...
    try:
        ...
        if entitlement_check is None:
            ...
            entitlement_check = managed_wundercorp_tools_enabled
