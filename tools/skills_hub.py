...
Used by loki_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "LOKI_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"LOKI_HOME": _loki_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'LOKI_INDEX_TTL': ('tools.skills_hub_search', 'LOKI_INDEX_TTL'),
    'LOKI_INDEX_URL': ('tools.skills_hub_search', 'LOKI_INDEX_URL'),
    'LokiIndexSource': ('tools.skills_hub_official', 'LokiIndexSource'),
