...
from tools.managed_tool_gateway import build_vendor_gateway_url, read_wundercorp_access_token
...
def is_managed_wundercorp_gateway_url(
    ...
    ``evil-connector-gateway.wundercorp.com.attacker.dev`` and an ``http``
