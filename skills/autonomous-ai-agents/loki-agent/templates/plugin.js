/**
 * Loki desktop plugin template. Save as:
 *   <loki home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <loki home> is ~/.loki by default, or ~/.loki/profiles/<name>
 * when running a named profile (`loki -p <name>`). Run `loki doctor` (or
 ...
 * Only these imports resolve: @wundercorp/loki-plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@wundercorp/loki-plugin-sdk'
