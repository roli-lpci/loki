...
- **Cobalt Primary** (`#306cce`): Doku primary dark — used in documentation contexts for links and interactive focus states.
...
- Lazy loading for below-fold images (Doku default behavior)
