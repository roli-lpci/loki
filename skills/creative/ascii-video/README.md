...
Built for [Loki Agent](https://github.com/wundercorp/loki). Usable in any coding agent. Canonical source lives here; synced to [`wundercorp/loki/skills/creative/ascii-video`](https://github.com/wundercorp/loki/tree/main/skills/creative/ascii-video) via PR.
