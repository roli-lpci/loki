...
const STORAGE_KEY = "loki-dashboard-theme";
...
const FONT_STORAGE_KEY = "loki-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + WunderCorp-blue rebrand.
  "lens-5i": "wundercorp-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `loki_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "loki-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-loki-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-loki-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. WunderCorp Blue) doesn't leave its values behind when the user
