...
import { ListItem } from "@wundercorp/loki-ui/ui/components/list-item";
import { Segmented } from "@wundercorp/loki-ui/ui/components/segmented";
...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    loki_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__loki_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-Loki-Session-Token":
              (window as unknown as { __LOKI_SESSION_TOKEN__?: string })
                .__LOKI_SESSION_TOKEN__ ?? "",
          },
        });
