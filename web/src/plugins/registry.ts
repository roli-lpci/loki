 ...
 *
 * Plugins call window.__LOKI_PLUGINS__.register(name, Component)
...
} from "@wundercorp/loki-ui/ui/components/dialog";
...
import { Card, CardHeader, CardTitle, CardContent } from "@wundercorp/loki-ui/ui/components/card";
import { Input } from "@wundercorp/loki-ui/ui/components/input";
import { Label } from "@wundercorp/loki-ui/ui/components/label";
import { Separator } from "@wundercorp/loki-ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@wundercorp/loki-ui/ui/components/tabs";
 ...
 * Exposed at runtime as ``window.__LOKI_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__LOKI_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__LOKI_PLUGIN_SDK__ = {
    ...
    // window.__LOKI_SESSION_TOKEN__ directly.
    authedFetch,
    ...
    // UI components — WunderCorp DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
