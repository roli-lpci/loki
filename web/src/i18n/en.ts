...
export const en: Translations = {
  ...
  status: {
    ...
    updateLokiConfirmMessage:
      "This runs loki update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateLokiConfirmNow: "Update now",
    updateLokiConfirmTitle: "Update Loki?",
    updatingLoki: "Updating Loki…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Loki plugins (`loki plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.loki/plugins/?",
    removeHint: "Only user-installed plugins under ~/.loki/plugins can be removed.",
    ...
    catalogHint:
      "Curated, WunderCorp-reviewed plugins pinned to exact commits. Install from here for supply-chain-safe versions.",
    catalogSearchPlaceholder: "Search catalog...",
    catalogEmpty: "No catalog entries match.",
    catalogEmptyDocsLink: "Learn about Loki plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.loki/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Loki doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Loki Achievements",
      subtitle:
        "Collectible Loki badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Loki session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Loki more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Loki sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Loki is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Loki Agent ☤",
    },
  },
