 ...
 *
 * Values mirror loki_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Loki default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Loki' default when unset). */
