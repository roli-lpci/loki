...
import { Card } from "@wundercorp/loki-ui/ui/components/card";
...
export function ChatSidebar({
  ...
  // /api/events in loki_cli/web_server.py for the broadcast hop.
  //
  ...
  useEffect(() => {
    ...
    // keeps the outer effect synchrowundercorp so its ``return cleanup`` stays at
