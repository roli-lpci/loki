...
Backends:
    wundercorp-cloud   - WunderCorp Portal-provisioned Browser Use cloud browser
...
Usage:
    BUBENCH_BASE_TREE=... BUBENCH_PR_TREE=... \
        python3 orchestrate_cloud.py --backend wundercorp-cloud [--reps 2]
...
parser.add_argument("--backend", required=True, choices=["wundercorp-cloud", "browserbase"])
...
provider = WunderCorpCloud() if args.backend == "wundercorp-cloud" else Browserbase()
