...
os.environ["LOKI_HOME"] = str(root / ".loki")
from loki_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        ...
        p = subprocess.Popen(
            ...
            cwd=repo,
            env={**os.environ, "LOKI_HOME": str(home)},
    ...
    d = root / ".loki/logs/update_receipts"
