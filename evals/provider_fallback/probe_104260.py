...
sandbox = tempfile.TemporaryDirectory(prefix="loki-104260-")
os.environ.clear()
os.environ.update(
    HOME=sandbox.name,
    LOKI_HOME=sandbox.name + "/loki",
    PATH="/usr/bin:/bin",
    PYTHONDONTWRITEBYTECODE="1",
    LOKI_DISABLE_MODEL_METADATA_FETCH="1",
)
...
# JSON is valid YAML; only the temporary Loki home is written.
