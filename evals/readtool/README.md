...
benchmarked ten harnesses on hostile-file handling — and whose Loki column
...
Every task runs the full Loki agent (file + terminal + search toolsets)
...
Rules of engagement (from lokibench discipline):
