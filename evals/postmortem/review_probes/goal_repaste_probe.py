...
from loki_cli import cli_commands_mixin, goals
...
server._loki_home = Path(home.name)
...
with patch('loki_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
