...
os.environ.setdefault("LOKI_HOME", os.path.expanduser("~/.loki"))  # LIVE: real auxiliary judge calls (cents)
from loki_cli import goals
goal = ("Simplify the loki-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
