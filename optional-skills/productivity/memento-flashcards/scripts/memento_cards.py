...
Data file: $LOKI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_LOKI_HOME = Path(os.environ.get("LOKI_HOME", Path.home() / ".loki"))
DATA_DIR = _LOKI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
