...
def _state_dir() -> Path:
    ...
    # Default: $LOKI_HOME/watcher-state/, falling back to ~/.loki/watcher-state/.
    loki_home = os.environ.get("LOKI_HOME") or str(Path.home() / ".loki")
    return Path(loki_home) / "watcher-state"
