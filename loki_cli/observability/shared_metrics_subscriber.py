"""Relay subscriber for the persisted Loki shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Loki counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Loki shared metric: %s", metric_name, exc_info=True
                )
