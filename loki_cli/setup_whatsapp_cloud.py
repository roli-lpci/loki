...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Loki to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Loki needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Loki gateway in another terminal:",
        "         loki gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://loki.computer/docs/user-guide/",
