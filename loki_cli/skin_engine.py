"""Loki skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces LOKI_AGENT_LOGO)
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_LOKI_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _LOKI_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _build_skin_config(data: Dict[str, Any]) -> SkinConfig:
    ...
    # + automatic adaptation, which beats the default's blue light palette under a crimson skin.
    return SkinConfig(
...
def get_active_goodbye(fallback: str = "Farewell! 𓆩✧𓆪") -> str:
...
_STYLE_PALETTE = (
    ...
    ("title", "banner_title", "#60A5FA"), ("text", "banner_text", "#E6F1FF"),
    ("dim", "banner_dim", "#555555"), ("label", "ui_label", "@title"), ("warn", "ui_warn", "#FF8C00"),
    ("error", "ui_error", "#FF6B6B"), ("status_bg", "status_bar_bg", "#0B1220"),
    ...
    ("menu_bg", "completion_menu_bg", "#0B1220"), ("menu_current_bg", "completion_menu_current_bg", "#172554"),
...
def get_prompt_toolkit_style_overrides() -> Dict[str, str]:
    ...
    palette["badge_bg"] = skin.colors.get(
        "status_bar_strong", skin.colors.get("banner_title", "#60A5FA"))
    palette["badge_fg"] = skin.colors.get("status_bar_bg", "#0B1220")
