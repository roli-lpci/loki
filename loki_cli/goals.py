"""Persistent session goals — the Ralph loop for Loki.
...
# (schema DDL, FTS tables, first loki_cli.config import) measures ~300ms warm and more on slow
...
def _get_session_db() -> Optional[Any]:
    """Cached SessionDB per LOKI_HOME (profile switches pick the right DB); None on any failure.
