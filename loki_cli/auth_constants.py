...
Pure leaf: imports nothing from ``loki_cli.auth`` so the per-provider modules
(``auth_wundercorp``, ``auth_codex``, ...) can import it at module scope without cycles."""
...
# httpx is imported lazily (~30ms) because loki_cli.auth is on the interactive-CLI startup path
...
if TYPE_CHECKING:
    ...
    class _LazyHttpx:
        ...
        # set/del forward to the real module so monkeypatch.setattr("loki_cli.auth.httpx.Client")
...
# WunderCorp Portal defaults
DEFAULT_WUNDERCORP_PORTAL_URL = "https://portal.wundercorp.com"
DEFAULT_WUNDERCORP_INFERENCE_URL = "https://inference-api.wundercorp.com/v1"
...
DEFAULT_WUNDERCORP_WELCOME_URL = "https://welcome-api.wundercorp.com/v1"
DEFAULT_WUNDERCORP_CLIENT_ID = "loki-cli"
WUNDERCORP_INFERENCE_INVOKE_SCOPE = "inference:invoke"
WUNDERCORP_BILLING_MANAGE_SCOPE = "billing:manage"
DEFAULT_WUNDERCORP_SCOPE = WUNDERCORP_INFERENCE_INVOKE_SCOPE
WUNDERCORP_DEVICE_CODE_SOURCE = "device_code"
WUNDERCORP_AUTH_PATH_INVOKE_JWT = "invoke_jwt"
ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120       # refresh 2 min before expiry
WUNDERCORP_INVOKE_JWT_MIN_TTL_SECONDS = ACCESS_TOKEN_REFRESH_SKEW_SECONDS
...
try:  # Version tag for the Codex token-endpoint User-Agent; fall back if unavailable.
    from loki_cli import __version__ as _LOKI_CLI_VERSION
except Exception:  # pragma: no cover - version import should always succeed
    _LOKI_CLI_VERSION = "unknown"
CODEX_OAUTH_USER_AGENT = f"loki-cli/{_LOKI_CLI_VERSION}"
...
SPOTIFY_DOCS_URL = "https://loki.computer/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "https://loki.computer/docs/guides/oauth-over-ssh"
...
_wundercorp_err = _provider_error_factory("wundercorp")
