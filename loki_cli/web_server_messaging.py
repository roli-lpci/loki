...
from loki_cli.config import OPTIONAL_ENV_VARS, write_platform_config_field
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    "telegram": {
        "name": "Telegram", "description": "Run Loki from Telegram DMs, groups, and topics.",
        "docs_url": "https://core.telegram.org/bots/features#botfather",
        "env_vars": ("TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USERS", "TELEGRAM_PROXY"),
        "required_env": ("TELEGRAM_BOT_TOKEN",),
    },
    "discord": {
        "name": "Discord", "description": "Connect Loki to Discord DMs, channels, and threads.",
    ...
    "slack": {
        "name": "Slack",
        "description": "Use Loki from Slack via Socket Mode. Add allowed Slack member IDs so connected bots can respond.",
    ...
    "mattermost": {
        "name": "Mattermost",
        "description": "Connect Loki to Mattermost channels and direct messages.",
        "docs_url": "https://mattermost.com/deploy/",
        "env_vars": ("MATTERMOST_URL", "MATTERMOST_TOKEN", "MATTERMOST_ALLOWED_USERS"),
        "required_env": ("MATTERMOST_URL", "MATTERMOST_TOKEN"),
    },
    "matrix": {
        "name": "Matrix", "description": "Use Loki in Matrix rooms and direct messages.",
    ...
    "whatsapp": {
        "name": "WhatsApp",
        "description": "Use Loki through the bundled WhatsApp bridge with QR-based auth.",
    ...
    "homeassistant": {
        "name": "Home Assistant",
        "description": "Control your smart home from Loki via Home Assistant.",
    ...
    "dingtalk": {
        "name": "DingTalk", "description": "Connect Loki to DingTalk groups (钉钉).",
        "docs_url": "https://open.dingtalk.com/document/orgapp/the-robot-development-process",
        "env_vars": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
        "required_env": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
    },
    "feishu": {
        "name": "Feishu / Lark", "description": "Use Loki inside Feishu / Lark.",
    ...
    "bluebubbles": {
        ...
        "description": "Use Loki through iMessage via a BlueBubbles server.",
    ...
    "qqbot": {
        "name": "QQ Bot", "description": "Connect Loki to a QQ Bot from the QQ Open Platform.",
    ...
    "relay": {
        ...
        "description": "Generic relay adapter fronted by the Loki Relay connector.",
...
def _whatsapp_session_path() -> Path:
    ...
    return get_loki_dir("platforms/whatsapp/session", "whatsapp/session")
...
_TELEGRAM_ONBOARDING_DEFAULT_URL = "https://setup.loki-agent.wundercorp.com"
_TELEGRAM_ONBOARDING_USER_AGENT = f"LokiDashboard/{__version__}"
