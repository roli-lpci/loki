...
class CLITuiMixin:
    ...
    def _tui_set_base_style(self):
        ...
        self._tui_style_base = {
            ...
            'hint': '#888888 italic',
            'status-bar': 'bg:#06142D #CBD5E1',
            'status-bar-strong': 'bg:#06142D #60A5FA bold',
            'status-bar-dim': 'bg:#06142D #64748B',
            'status-bar-good': 'bg:#06142D #4ADE80 bold',
            'status-bar-warn': 'bg:#06142D #FBBF24 bold',
            'status-bar-bad': 'bg:#06142D #FB923C bold',
            'status-bar-critical': 'bg:#06142D #F87171 bold',
            'status-bar-yolo': 'bg:#06142D #EF4444 bold',
            'status-bar-session-title': 'bg:#60A5FA #06142D bold',
            'input-rule': '#2563EB',
            'image-badge': '#87CEEB bold',
            'completion-menu': 'bg:#06142D #EFF6FF',
            'completion-menu.completion': 'bg:#06142D #EFF6FF',
            'completion-menu.completion.current': 'bg:#0B1F3A #60A5FA',
            'completion-menu.meta.completion': 'bg:#06142D #64748B',
            'completion-menu.meta.completion.current': 'bg:#0B1F3A #60A5FA',
            'clarify-border': '#2563EB',
            'clarify-title': '#60A5FA bold',
            'clarify-question': '#EFF6FF bold',
            ...
            'voice-status': 'bg:#06142D #60A5FA',
            'voice-status-recording': 'bg:#06142D #EF4444 bold'}
