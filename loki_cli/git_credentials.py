"""Non-interactive HTTPS credentials for Loki's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``loki plugins install`` with
