...
``@wundercorp/loki-ui`` design system; fonts load from the SPA's ``/fonts/``
...
<title>Sign in — Loki Agent</title>
<style>
  /* Brand fonts shipped by @wundercorp/loki-ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">WunderCorp<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Loki Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Loki Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
