"""Shared migration guards for Loki' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "LOKI_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "LOKI_NEMO_RELAY_ATOF_ENABLED",
    "LOKI_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "LOKI_NEMO_RELAY_ATOF_FILENAME",
    "LOKI_NEMO_RELAY_ATOF_MODE",
    "LOKI_NEMO_RELAY_ATIF_ENABLED",
    "LOKI_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "LOKI_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "LOKI_NEMO_RELAY_ATIF_AGENT_NAME",
    "LOKI_NEMO_RELAY_ATIF_AGENT_VERSION",
    "LOKI_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "LOKI_NEMO_RELAY_ATIF_MODEL_NAME",
    "LOKI_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
