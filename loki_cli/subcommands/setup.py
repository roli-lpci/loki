...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'loki setup' now does this.")
    setup_parser.add_argument(
    ...
    setup_parser.add_argument(
        ...
        help="One-shot WunderCorp Portal setup: log in via OAuth, pick a WunderCorp "
        "model, set WunderCorp as the inference provider, and opt into the Tool "
