"""Client for uploading ``loki debug share`` bundles to WunderCorp-internal S3.
...
NAS_BASE = os.environ.get("LOKI_DIAGNOSTICS_BASE_URL", "https://portal.wundercorp.com")
_REQUEST_TIMEOUT = 30
...
def share_to_wundercorp(report_bundle: bytes) -> dict:
