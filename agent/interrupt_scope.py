"""Host-owned cancellation for agents created deep inside synchrowundercorp work.

A host that runs a blocking command on a worker thread (Loki Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("loki_interrupt_scope", default=None)
