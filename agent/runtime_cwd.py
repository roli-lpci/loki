...
_SESSION_CWD: ContextVar = ContextVar("LOKI_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Loki source tree, a
    legitimate workspace when developing Loki; fallback-directory policy lives in the caller."""
