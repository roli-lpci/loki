...
# (more tokens per task, not a higher rate); the Loki-side "-900k" Codex
...
def resolve_billing_route(
    ...
    if provider_name == "wundercorp" or host("inference-api.wundercorp.com"):
        return BillingRoute(provider="wundercorp", model=model, base_url=base_url or _WUNDERCORP_DEFAULT_BASE_URL, billing_mode="official_models_api")
