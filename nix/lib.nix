      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via LOKI_BUNDLED_SKILLS /
            # LOKI_OPTIONAL_SKILLS (see loki-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + LOKI_BUNDLED_LOCALES
            # / LOKI_OPTIONAL_MCPS, not via the wheel. Excluding them
