...
integration contracts: control actions are synchrowundercorp (never
...
def test_delegate_task_routes_control_action_before_spawn_machinery():
    """action='list' must return synchrowundercorply without touching spawn paths
...
def test_empty_tasks_array_with_goal_is_single_task_not_batch_error():
    ...
    batch-count gate (observed live with gpt-5.4-mini on WunderCorp Portal) —
