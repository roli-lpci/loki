...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `loki model` to select "
    "a provider, or run `loki setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for WunderCorp Portal login."
