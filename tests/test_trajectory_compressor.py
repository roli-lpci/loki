...
def test_import_loads_env_from_loki_home(tmp_path, monkeypatch):
    home = tmp_path / ".loki"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-loki-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-loki-home"
