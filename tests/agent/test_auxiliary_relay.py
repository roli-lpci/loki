...
from loki_cli.observability.shared_metrics_contract import MODEL_ROUTE_METRIC
from loki_cli.observability.shared_metrics_subscriber import SharedMetricsSubscriber
...
def test_auxiliary_provider_fallback_records_one_terminal_model_route(
    ...
    assert snapshot[0]["resource"]["loki_version"] == "test-version"
