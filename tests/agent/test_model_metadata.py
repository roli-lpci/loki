...
class TestDefaultContextLengths:
    ...
    def test_muse_spark_resolves_1m_without_network(self, model, provider, base_url):
        ...
        live /models probe are unavailable (fresh LOKI_HOME, offline)."""
        with patch("agent.model_metadata.get_cached_context_length", return_value=None), \
             patch("agent.model_metadata._query_ollama_api_show", return_value=None), \
             patch("agent.model_metadata.fetch_endpoint_model_metadata", return_value={}), \
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        # / WunderCorp Portal) to 1M without probing down to the legacy 128K
...
# =========================================================================
# WunderCorp Portal context-window resolution (provider="wundercorp")
# =========================================================================

class TestWunderCorpPortalContextResolution:
    """WunderCorp Portal /v1/models is authoritative for what WunderCorp infra enforces
    ...
    def test_empty_model_never_fuzzy_matches_endpoint_catalog(self, mock_fetch):
        ...
        the WunderCorp portal) and poisoned the resolved context length."""
        import agent.model_metadata as mm
        ...
        assert mm._resolve_endpoint_context_length(
            "grok-4.6", "https://inference-api.wundercorp.com/v1"
        ) == 500_000
    ...
    def test_stale_cache_is_bypassed_and_overwritten_by_portal(
        ...
        """Users upgrading from pre-fix builds have ``qwen3.6-plus@…wundercorp… =
