...
from loki_cli.wundercorp_account import WunderCorpPortalAccountInfo, WunderCorpPaidServiceAccessInfo
...
def test_credits_command_fully_removed():
    ...
    from loki_cli.commands import resolve_command, COMMAND_REGISTRY
