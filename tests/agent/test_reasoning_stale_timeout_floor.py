...
thinking phase.  Loki's default cloud-stream stale detector
(``LOKI_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``LOKI_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
