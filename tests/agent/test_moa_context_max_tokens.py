...
def test_aggregator_call_never_receives_reference_max_tokens(loki_home, monkeypatch):
...
def test_aggregator_call_uncapped_when_reference_max_tokens_unset(loki_home, monkeypatch):
