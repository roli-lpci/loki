...
The unit tests in tests/loki_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned loki-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/loki")
from loki_cli.service_manager import S6ServiceManager
