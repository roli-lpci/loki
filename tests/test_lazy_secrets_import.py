"""Regression test: loki update must not load cryptography eagerly."""
...
assert 'loki_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running loki update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so loki_cli is importable,
