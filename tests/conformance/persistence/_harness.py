...
def make_loki_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated LOKI_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"loki-home-{journal_mode}"
