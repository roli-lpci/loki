...
from loki_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/loki_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("loki_cli.lifecycle.invoke_hook")
@patch("loki_cli.lifecycle.finalize_session")
