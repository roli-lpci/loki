...
Keeps the ACP server tests offline: ``LokiACPAgent._build_model_state``
calls ``loki_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import loki_cli.inventory as inventory
