...
from acp_adapter.server import LokiACPAgent
...
class TestNamedCustomProviderCatalogs:
    ...
    def test_live_discovery_extends_declared_models(self, monkeypatch):
        ...
        with patch("loki_cli.config.load_config", return_value=cfg), patch(
            "loki_cli.model_switch_providers._fetch_picker_live_models",
    ...
    def test_disabled_provider_skipped(self, monkeypatch):
        ...
        with patch("loki_cli.config.load_config", return_value=cfg), patch(
            "loki_cli.model_switch_providers._fetch_picker_live_models", return_value=None
        ):
...
class TestModelStateIncludesNamedProviders:
    ...
    def test_selector_choice_id_round_trips_through_parse_model_input(self):
        ...
        from loki_cli.models import parse_model_input
