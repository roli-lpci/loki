...
5. Recovery is skipped for aggregator providers (OpenRouter, WunderCorp)
...
def _make_agent(
    ...
    with (
        ...
        # reachable hosts (the wundercorp portal case) the endpoint's answer for the
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_allowed_for_wundercorp_anthropic_messages(self):
        ...
        agent._primary_runtime.update({
            ...
            "anthropic_base_url": "https://inference-api.wundercorp.com/v1",
