"""Session <-> workspace grouping key (loki_state_sessions.workspace_key).

The key is what `loki sessions list --workspace` groups/filters on. It is a
...
import loki_state_sessions
from loki_state_sessions import workspace_key
