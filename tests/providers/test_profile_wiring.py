...
class TestWunderCorpProfileParity:
    def test_tags(self, transport):
        legacy = transport.build_kwargs(
            model="loki-3", messages=_msgs(), tools=None, provider_profile=get_provider_profile("wundercorp"),
        )
        profile = transport.build_kwargs(
            model="loki-3", messages=_msgs(), tools=None,
