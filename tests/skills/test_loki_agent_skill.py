"""The `loki-agent` skill is what a running Loki knows about itself.

`website/` is never packaged, so an installed Loki has no local copy of the
user guide; skills ARE synced into `$LOKI_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Loki can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "loki-agent"
