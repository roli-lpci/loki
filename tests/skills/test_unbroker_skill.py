...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and loki-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # loki-agent (tests/skills/)
]
