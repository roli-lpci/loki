...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded loki-temp-hello (0.74 sec)\n"
        "Deployed loki-temp-hello triggers (0.42 sec)\n"
        "  https://loki-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://loki-temp-hello.serene-temple.workers.dev"
