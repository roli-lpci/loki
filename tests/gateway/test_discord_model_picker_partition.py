...
provider whose list exceeds 25 entries (e.g. WunderCorp curated + Portal free
...
def test_wundercorp_free_models_render_across_partitioned_selects():
    ...
    view._selected_provider = "wundercorp"
    view._build_model_select("wundercorp")
