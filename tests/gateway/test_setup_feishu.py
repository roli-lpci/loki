"""Tests for _setup_feishu() in loki_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("loki_cli.config.save_env_value", side_effect=mock_save), \
         patch("loki_cli.config.get_env_value", side_effect=mock_get), \
         patch("loki_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("loki_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("loki_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("loki_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("loki_cli.cli_output.print_header"), \
         patch("loki_cli.cli_output.print_info"), \
         patch("loki_cli.cli_output.print_success"), \
         patch("loki_cli.cli_output.print_warning"), \
         patch("loki_cli.cli_output.print_error"), \
