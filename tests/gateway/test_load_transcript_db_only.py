...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.loki/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at loki_state import time, before pytest's LOKI_HOME monkeypatch
    fires — the autouse fixture's LOKI_HOME override doesn't help here.)
    """
    import loki_state
