"""Tests for the specifier module + `loki kanban specify` CLI surface.
...
from loki_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `loki kanban …` argparse surface directly."""
