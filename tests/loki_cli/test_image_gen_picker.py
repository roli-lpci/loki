...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_wundercorp_active_label(self, monkeypatch):
        from loki_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config, **kwargs: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_wundercorp=True)}
            ),
        )
        ...
        assert tools_config._is_provider_active(wundercorp_row, config) is False
