"""Tests for the shared byte formatter (loki_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from loki_cli.backup import _format_size as backup
    from loki_cli.checkpoints import _fmt_bytes as checkpoints
    from loki_cli.sizefmt import format_bytes as doctor
