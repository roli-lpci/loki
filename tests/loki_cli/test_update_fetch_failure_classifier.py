"""Fetch-failure classification for `loki update` / `loki update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/wundercorp/loki.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `loki update` sit on
    ...
    from loki_cli import update_cmd_git
