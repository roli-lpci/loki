"""Regression: ``loki update`` should take a managed checkout off autocrlf=true.
...
``loki update`` has to repair them.
...
from loki_cli.update_cmd import _normalize_managed_eol
