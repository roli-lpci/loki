...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (loki_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_loki_overlays():
    """loki_cli.providers.get_provider("vertex") backs
