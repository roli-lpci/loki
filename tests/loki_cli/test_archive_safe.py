"""Tests for the shared tar.gz writer (``loki_cli.archive_safe.make_targz``).

``make_targz`` backs both ``loki profile export`` and ``loki kanban
...
from loki_cli.archive_safe import make_targz
