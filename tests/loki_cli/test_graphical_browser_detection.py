"""Tests for `_can_open_graphical_browser()` in loki_cli.auth.

Guards the fix for the May 2026 report where `loki auth add xai-oauth`
...
from loki_cli.auth import _can_open_graphical_browser
