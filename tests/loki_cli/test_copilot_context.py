...
class TestGetCopilotModelContext:
    ...
    @patch("loki_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("loki_cli.models._urlopen_model_catalog_request")
    ...
    @patch("loki_cli.models.fetch_github_model_catalog", return_value=[])
