"""Tests for ``loki approvals suggest`` (loki_cli/approvals_suggest.py).

Approval history in Loki is implied, not ledgered: the session DB
...
from loki_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
