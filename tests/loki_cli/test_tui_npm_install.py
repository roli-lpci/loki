...
def test_make_tui_argv_uses_bundled_tui_when_workspace_missing(
    ...
    loki_cli/tui_dist/entry.js but never ships ui-tui/ (that directory only
...
def test_need_install_when_linked_workspace_dep_missing(tmp_path: Path, main_mod) -> None:
    """The closure follows workspace symlinks (@wundercorp/loki-ink → ui-tui/packages/…)
    so a linked workspace's own missing dep triggers a reinstall."""
    tui_dir = _write_ws(
        tmp_path,
        '{"packages":{'
        '"ui-tui":{"dependencies":{"@wundercorp/loki-ink":"*"}},'
        '"node_modules/@wundercorp/loki-ink":{"link":true,"resolved":"ui-tui/packages/loki-ink"},'
        '"ui-tui/packages/loki-ink":{"dependencies":{"inkdep":"1.0.0"}},'
...
def test_workspace_closure_includes_dev_deps_of_selected_child_workspace(main_mod) -> None:
    ...
    packages = {
        ...
        "node_modules/@wundercorp/loki-ink": {
            "link": True,
            "resolved": "ui-tui/packages/loki-ink",
        },
        "ui-tui/packages/loki-ink": {"devDependencies": {"child-dev-only": "1"}},
    ...
    termux = main_tui_launch._npm_lock_workspace_closure(
        packages, {"ui-tui", "ui-tui/packages/loki-ink"}
    )
...
def test_termux_install_catches_missing_child_workspace_dev_dep(
    ...
    ws_lock = (
        ...
        '"ui-tui":{"dependencies":{"@wundercorp/loki-ink":"*"}},'
        '"node_modules/@wundercorp/loki-ink":{"link":true,"resolved":"ui-tui/packages/loki-ink"},'
        '"ui-tui/packages/loki-ink":{"devDependencies":{"child-dev-only":"1.0.0"}},'
...
def test_no_stray_lockfiles_in_workspace_subdirs(main_mod) -> None:
    ...
    # Also sweep ui-tui/packages/* (loki-ink etc.)
