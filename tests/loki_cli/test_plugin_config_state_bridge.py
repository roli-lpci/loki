...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\Loki 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\Loki 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\Loki 🚀"
...
"""
    env = dict(os.environ, LOKI_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(
