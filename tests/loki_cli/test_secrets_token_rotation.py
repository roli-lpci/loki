"""Tests for `loki secrets bitwarden token` / `loki secrets onepassword token`.
...
from loki_cli import onepassword_secrets_cli as op_cli
from loki_cli import secrets_cli as bw_cli
