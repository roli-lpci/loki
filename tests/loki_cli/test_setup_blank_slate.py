"""Tests for Blank Slate setup mode (loki_cli/setup.py).
...
from loki_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
