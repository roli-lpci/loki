...
import loki_cli.model_switch_providers as loki_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(loki_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("loki_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import loki_cli.models as hm
    import loki_cli.models_catalog_static as loki_cli_models_catalog_static
    from loki_cli import models_catalog_static
    ...
    monkeypatch.setattr(loki_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
