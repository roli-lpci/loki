...
Run before any catalog commit:
    ...
    LOKI_TEST_NETWORK=1 scripts/run_tests.sh tests/loki_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("LOKI_TEST_NETWORK"),
    reason="network test; set LOKI_TEST_NETWORK=1 to run",
)
