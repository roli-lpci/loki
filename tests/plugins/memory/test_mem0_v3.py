...
class TestMem0Prefetch:
    """prefetch() must recall on the CURRENT question, synchrowundercorply.
    ...
    def test_queue_prefetch_fires_no_search(self):
        # prefetch is synchrowundercorp now, so the post-turn warm is redundant and
