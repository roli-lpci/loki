...
Holds no scheduler credentials — speaks only to NAS ``agent-cron`` endpoints with the WunderCorp token.
...
class ChronosCronScheduler(CronScheduler):
    ...
    def is_available(self) -> bool:
        ...
        WunderCorp login; otherwise the resolver falls back to the built-in ticker."""
        ...
        try:
            ...
            return bool((get_provider_auth_state("wundercorp") or {}).get("access_token"))
        except Exception:
            return False
