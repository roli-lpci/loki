#!/usr/bin/env python3
"""Build the Loki Skills Index — a centralized JSON catalog of all skills.
...
`loki skills search/install` can use it without hitting the GitHub API.
...
# Ensure LOKI_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Loki Skills Index...", flush=True)
