...
def main() -> None:
    ...
    loki_home = Path(tempfile.mkdtemp(prefix="loki-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "loki-gateway-smoke",
    ...
    print(json.dumps({"loki_home": str(loki_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
