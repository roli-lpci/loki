#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Loki logs.
...
With no LOGFILE, reads ``$LOKI_HOME/logs/agent.log`` (default ~/.loki).
...
def default_log() -> Path:
    home = os.environ.get("LOKI_HOME") or str(Path.home() / ".loki")
