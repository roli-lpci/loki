...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Loki\s+(Agent|Audit)$", re.IGNORECASE),
    re.compile(r"^wundercorpbot(-eng)?$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (loki-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@wundercorp.com",
    "cursoragent@cursor.com",
    "loki@wundercorp.com",
    "loki-audit@example.com",
    "wundercorpbot@wundercorp.com",
    "loki@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
