...
DEFAULT_DATASETS = [
    "WunderCorp/swe-terminus-agent-glm-kimi-minimax",
    "wundercorp/loki-megascience-sft1",
    "WunderCorp/Loki-Agent-Thinking-GLM-4.7-SFT2",
    "WunderCorp/Loki-Agent-Thinking-GLM-4.7-SFT1",
    "WunderCorp/terminal-tasks-glm-loki-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "WunderCorp/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload WunderCorp/{output_name} {final_output}")
