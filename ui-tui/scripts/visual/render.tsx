 ...
 * across theme x background scenes to <tmpdir>/loki-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@wundercorp/loki-ink'
...
// The regenerated slate light_colors block from loki_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/loki-agent',
...
const setup = (bgHex: string) => {
  process.env.LOKI_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
