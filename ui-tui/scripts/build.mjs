...
await build({
  ...
  // Skip the prebuilt @wundercorp/loki-ink bundle and inline the source instead:
  ...
  alias: { '@wundercorp/loki-ink': resolve(root, 'packages/loki-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The loki_cli launcher
