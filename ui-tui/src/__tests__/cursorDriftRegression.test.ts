 ...
 *
 * Symptom: in `loki --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@wundercorp/loki-ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using loki --tui and as i type multiline my caret at the end will often ' +
