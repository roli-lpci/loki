import type { BillingBlock, UsageModelData } from '@wundercorp/loki-shared/billing'
import type { LokiSkin } from '@wundercorp/loki-shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@wundercorp/loki-shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = LokiSkin
...
// Wire shapes now live in @wundercorp/loki-shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
  ...
  UsageBarData,
  UsageModelData
} from '@wundercorp/loki-shared/billing'
