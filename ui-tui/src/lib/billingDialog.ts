import type { BillingBlock } from '@wundercorp/loki-shared/billing'
 ...
 * confirm button carries the recovery: WunderCorp → `/topup`, other providers → their
...
export function billingDialogCopy(block: BillingBlock): BillingDialogCopy {
  if (block.is_wundercorp) {
    return {
      cancelLabel: 'Dismiss',
      confirmLabel: 'Top up',
      detail: 'Your WunderCorp credit balance is exhausted — top up to keep going.',
      title: 'Out of WunderCorp credits'
    }
  }
