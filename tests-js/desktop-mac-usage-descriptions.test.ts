 ...
 *
 * Each entry is a key/value pair that lands in the packaged Loki.app's
 ...
 * "Loki wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Loki wants to access Music" when Loki never touches the Music
