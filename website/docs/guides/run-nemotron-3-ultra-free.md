---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in Loki Agent"
description: "Try NVIDIA Nemotron 3 Ultra on WunderCorp Portal — free June 4–18 — with day 0 support in Loki Agent"
---

# Run Nemotron 3 Ultra free in Loki Agent

WunderCorp, Inc. has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [WunderCorp Portal](https://portal.wundercorp.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your Loki Agent today.
...
[Download the Loki Desktop installer](https://loki.computer/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect WunderCorp Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **WunderCorp Portal** (marked **Recommended**). Your browser opens — create a [WunderCorp Portal](https://portal.wundercorp.com) account (or sign in), choose the **Free** plan, and authorize Loki. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://loki.computer/install.sh), inspect it, then run it.
...
Select **Quick Setup**. Loki opens a browser tab and waits for you to finish the next steps.

### 3. Create a WunderCorp Portal account

In the browser, create a [WunderCorp Portal](https://portal.wundercorp.com) account (or sign in) and choose the **Free** plan.

### 4. Connect your account

When prompted to connect your account to Loki Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the WunderCorp Portal connection and that you're on the **Free** plan. In the CLI, `loki portal info` confirms you're logged in and routing through WunderCorp.
...
- **[Run Loki Agent with WunderCorp Portal](/guides/run-loki-with-wundercorp-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
- **[WunderCorp Portal integration](/integrations/wundercorp-portal)** — What's in the subscription
