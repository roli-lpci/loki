...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `loki_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `loki_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Loki Plugin](plugins/index.md) |
...
| Session storage | `loki_state.py`, `loki_state_*.py` | [Session Storage](session-storage.md) |
