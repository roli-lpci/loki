...
:::tip Start here
If you only have time to set up one inference integration, start with [OpenRouter](/integrations/providers). It gives Loki access to a broad model catalog through one API key.
:::
