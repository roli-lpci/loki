...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/health/neuroskill-bci` |
...
Connect Loki to a running [NeuroSkill](https://neuroskill.com/) instance to read
