...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/creative/comfyui` |
...
| Related skills | [`stable-diffusion`](/user-guide/skills/optional/mlops/mlops-stable-diffusion) |
