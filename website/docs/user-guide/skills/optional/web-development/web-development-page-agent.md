...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/web-development/page-agent` |
...
- User wants **Loki itself to drive a browser** → use Loki' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
