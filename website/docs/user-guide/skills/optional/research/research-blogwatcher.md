...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/research/blogwatcher` |
...
## Working with Loki tools (read this first)

`blogwatcher-cli` is the feed database; Loki tools do the automation around it:
