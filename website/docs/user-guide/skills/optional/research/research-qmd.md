...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`loki-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-loki-agent), [`arxiv`](/user-guide/skills/bundled/research/research-arxiv) |
...
Loki Agent via the native MCP client. This is the preferred
...
Then configure Loki Agent to connect via HTTP:
