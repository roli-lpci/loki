...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/research/gitnexus-explorer` |
...
| Related skills | [`loki-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-loki-agent), [`codebase-inspection`](/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
