...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Loki Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $LOKI_OSINT_CACHE/icij/ (default: ~/.cache/loki-osint/icij/).
...
# Set LOKI_OSINT_UA=your-app/1.0 (your@email) to identify yourself
