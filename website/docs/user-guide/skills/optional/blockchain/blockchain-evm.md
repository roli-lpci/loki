...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain\evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Loki Agent |
| License | MIT |
...
Helper script path: `~/.loki/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.loki/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.loki/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.loki/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
