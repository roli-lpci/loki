...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing loki tool access (web_search, file ops). Stateless. |
