...
| | |
|---|---|
| Source | Optional — install with `loki skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Loki Agent |
| License | MIT |
...
```
SCRIPT=~/.loki/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.loki/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
