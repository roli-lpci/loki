...
/** A normal fast TTY: write succeeds and drains synchrowundercorply. */
...
describe('Ink stdout backpressure coalescing (issue #31486)', () => {
  ...
  it('never coalesces on a fast terminal that drains synchrowundercorply', () => {
    ...
    // Each changed render writes immediately — synchrowundercorp drain clears the
