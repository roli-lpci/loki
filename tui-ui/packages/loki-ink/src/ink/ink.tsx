...
export default class Ink {
  ...
  // synchrowundercorply in handleResize would leave the screen blank for the ~80ms
  ...
  // Fold synchrowundercorp re-entry (selection fanout, onFrame callback)
  ...
  constructor(private readonly options: Options) {
    ...
    // synchrowundercorply. Deferring to a microtask runs onRender after layout
    ...
    // existing synchrowundercorp lastFrame() tests are unaffected.
   ...
   * with no side effects — call it synchrowundercorply at click time so the
  ...
  unmount(error?: Error | number | null): void {
    ...
    // Clean up terminal modes synchrowundercorply before process exit.
