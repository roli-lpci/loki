import { Box, type ScrollBoxHandle, stringWidth, Text } from '@wundercorp/loki-ink'
...
export function StatusRule({
  ...
  // Dev-only readout (LOKI_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (LOKI_DEV_CREDITS), lowest priority,
