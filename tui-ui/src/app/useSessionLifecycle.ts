...
import type { ScrollBoxHandle } from '@wundercorp/loki-ink'
import { evictInkCaches } from '@wundercorp/loki-ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.LOKI_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
