...
** with the [PRAGMA synchrowundercorp]=NORMAL and [PRAGMA synchrowundercorp]=FULL
** settings.  The [synchrowundercorp pragma] determines when calls to the
...
** [PRAGMA synchrowundercorp | PRAGMA synchrowundercorp=OFF] it is invoked in place
