/**
 * Canonical Loki skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$LOKI_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`loki_cli/skin_engine.py`),
 ...
 *   • CLI     → `loki_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
