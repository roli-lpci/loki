 ...
 * renderer process. The @wundercorp/loki-plugin-sdk host is mocked: notify/navigate
 * calls are asserted, never really executed.
 */

import type { PluginRestOptions } from '@wundercorp/loki-plugin-sdk'
...
vi.mock('@wundercorp/loki-plugin-sdk', () => ({
  host: hostMock,
