...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/loki-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'loki_cli/config_defaults.py'), 'utf8')
