...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@wundercorp/loki-plugin-sdk'
 ...
 *  (loki-agent#90102) and are discarded. Without `canonical_session` (older
