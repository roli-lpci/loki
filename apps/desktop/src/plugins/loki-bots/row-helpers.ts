...
import { atom, host, useValue } from '@wundercorp/loki-plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @loki, never @default (#89484).
 ...
 *  (loki-agent#90268). Older gateways omit worker_session — always false. */
