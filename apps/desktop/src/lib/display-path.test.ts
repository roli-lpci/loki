...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/loki-agent')).toBe('~/www/loki-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/loki-agent')).toBe('loki-agent')
    expect(pathLeaf('~/www/loki-agent')).toBe('loki-agent')
