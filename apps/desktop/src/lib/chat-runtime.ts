...
import type { ModelOptionsResponse, SessionInfo } from '@/types/loki'
 ...
 *
 * Only the leading status prefix (e.g. "Loki is thinking...") and the
 ...
 *  resolved comment as JSON (LokiPrComment shape); a malformed payload falls
