...
import type * as LokiApi from '@/loki'
...
vi.mock('@/loki', async importOriginal => ({
  ...(await importOriginal<typeof LokiApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'loki-skill-pick', name: 'web-research', identifier: 'web-research' },
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { lokiDesktop?: unknown }).lokiDesktop = { connections, getAgentRoster }
