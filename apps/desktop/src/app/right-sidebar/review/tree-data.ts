import type { LokiReviewFile } from '@/global'
...
export function buildReviewFlatList(files: LokiReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: LokiReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
