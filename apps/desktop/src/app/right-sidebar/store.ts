...
const TAKEOVER_KEY = 'loki.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Loki can't clear via the API — the user
 *  sees exactly what runs instead of Loki silently deleting their creds. */
