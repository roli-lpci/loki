...
const STORAGE_KEY = 'loki.desktop.terminals.v1'
...
describe('terminal store persistence', () => {
  ...
  it('persists user tabs and history synchrowundercorply, skipping agent mirrors', async () => {
    ...
    // No flush/tick: persistence is synchrowundercorp, so the snapshot is already on
