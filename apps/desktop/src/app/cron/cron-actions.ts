import { type CronJob, getApiRequestConnection, getCronJobs, triggerCronJob } from '@/loki'
import {
  beginCronJobsAction,
...
/**
 * Trigger a job synchrowundercorply, then replace the local view from the backend.
