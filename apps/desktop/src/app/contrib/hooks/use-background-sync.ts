...
import { getLatestSessionMessages, type ProfileScope } from '@/loki'
...
interface BackgroundSyncParams {
  ...
  refreshLokiConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshLokiConfig])
}
