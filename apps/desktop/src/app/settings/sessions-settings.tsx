...
import type { LokiConfigRecord, SessionInfo } from '@/types/loki'
...
// / Program Files), which buried any files Loki wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.lokiDesktop` is
    ...
    const settings = window.lokiDesktop?.settings
