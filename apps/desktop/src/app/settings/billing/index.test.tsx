...
describe('BillingSettings', () => {
  ...
  it('renders logged-out as a connect card without normal account rows', async () => {
    ...
    expect(await screen.findByText('Connect your WunderCorp account')).toBeTruthy()
    expect(screen.getByText('Run /portal in the TUI or open the WunderCorp portal to connect your account.')).toBeTruthy()
