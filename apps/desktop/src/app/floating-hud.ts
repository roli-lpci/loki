...
// hairline `--stroke-wundercorp` paired with the soft `--shadow-wundercorp` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-wundercorp) bg-(--ui-chat-bubble-background) shadow-wundercorp [-webkit-app-region:no-drag]'
