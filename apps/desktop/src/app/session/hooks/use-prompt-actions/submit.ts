...
import { PROMPT_SUBMIT_REQUEST_TIMEOUT_MS } from '@/loki'
  ...
  return useCallback(
    async (rawText: string, options?: SubmitTextOptions) => {
      ...
      if (!sessionId) {
        ...
        // synchrowundercorply, so it only still equals the id create returned when
      ...
      try {
        ...
        const submitParams = (targetId: string) => ({
          ...
          // rather than at Loki. The gateway turns this into a per-turn hint
