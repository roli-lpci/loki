...
import { getLokiConfigRecord, listAllProfileSessions } from '@/loki'
...
// Loki session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-loki',
            keywords: ['update', 'upgrade', 'loki', 'version', 'system', 'restart'],
            label: cc.updateLoki,
  ...
  const searchGroups = useMemo<PaletteGroup[]>(() => {
    ...
    // Apply a theme directly from the root search (e.g. "wundercorp" → WunderCorp). Live
