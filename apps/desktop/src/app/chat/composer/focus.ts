 ...
 *
 * `dispatch` defers to a macrotask so synchrowundercorp click/keydown handlers
...
const FOCUS_EVENT = 'loki:composer-focus'
const INSERT_EVENT = 'loki:composer-insert'
const ATTACH_IMAGES_EVENT = 'loki:composer-attach-images'
const INSERT_REFS_EVENT = 'loki:composer-insert-refs'
const SUBMIT_EVENT = 'loki:composer-submit'
const VOICE_TOGGLE_EVENT = 'loki:composer-voice-toggle'
const MODEL_MENU_EVENT = 'loki:composer-model-menu'
