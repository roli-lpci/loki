...
export function ChatBar({
  ...
  const hudWindowing = window.lokiDesktop?.hud?.windowing
  ...
  // keydown paths re-read it synchrowundercorply), so collapsing the input/paste
  ...
  const input = (
    <div className={cn('relative', stacked ? 'w-full' : 'min-w-(--composer-input-inline-min-width) flex-1')}>
      ...
      {/* assistant-ui requires ComposerPrimitive.Input somewhere in the tree
        ...
        forcing two synchrowundercorp layouts per keystroke for an element the
