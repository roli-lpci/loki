...
import type { LokiGitBranch } from '@/global'
...
const branchActionLabel = (branch: LokiGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<LokiGitBranch[]>([])
  ...
  const convert = async (branch: LokiGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
