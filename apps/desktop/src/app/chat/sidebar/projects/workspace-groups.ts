...
import type { ProjectInfo, SessionInfo } from '@/loki'
 ...
 * repo shows its branches/worktrees even when they have no Loki sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: LokiGitWorktree[]
): SidebarSessionGroup[] {
