...
// (#73044). Exercises the REAL loki + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/loki')
...
const conn = (over: Partial<LokiConnection> = {}): LokiConnection =>
  ({
    authMode: 'oauth',
