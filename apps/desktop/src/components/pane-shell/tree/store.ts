...
const STORAGE_KEY = 'loki.desktop.layoutTree.v2'

writeKey('loki.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('loki.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('loki.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'loki.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'loki.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'loki.desktop.hiddenStripTabs.v1'
...
writeKey('loki.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__LOKI_LAYOUT_TREE__ = {
    close: closeTreePane,
