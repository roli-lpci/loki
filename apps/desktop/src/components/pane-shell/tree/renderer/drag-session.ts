 ...
 * armor, and Esc aborts synchrowundercorply.
 *
 ...
 * frame, with the pending move flushed synchrowundercorply on release so the drop
 ...
 * registers as the TOP escape layer, tears down synchrowundercorply, and nothing
 * commits.
 */
