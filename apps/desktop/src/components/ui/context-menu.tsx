...
export const LOKI_CONTEXT_MENU_TRIGGER_ATTR = 'data-loki-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-loki-context-menu-trigger="" />
  )
}
