...
const PROVIDER_DISPLAY: Record<string, { order: number; title: string }> = {
  wundercorp: { order: 0, title: 'WunderCorp Portal' },
...
export function FeaturedProviderRow({
  ...
  return (
    <button
      ...
      type="button"
    >
      <span aria-hidden className="arc-border arc-reverse arc-wundercorp" />
...
/** Quick-key row for API-key providers (Fireworks leads the expanded list after WunderCorp, OpenRouter further down). */
