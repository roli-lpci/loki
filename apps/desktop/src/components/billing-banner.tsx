 ...
 * usable — it only offers recovery: WunderCorp opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_wundercorp ? copy.titleWunderCorp : copy.titleProvider(block.provider_label)
