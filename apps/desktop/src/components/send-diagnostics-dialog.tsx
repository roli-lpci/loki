...
//               discussion: GitHub Issues · WunderCorp Portal Support · Discord.
...
const SUPPORT_LINKS = [
  { key: 'github', url: 'https://github.com/wundercorp/loki/issues' },
  { key: 'portal', url: 'https://portal.wundercorp.com/help' },
  { key: 'discord', url: 'https://discord.gg/yEaT8dv5Xn' }
] as const
