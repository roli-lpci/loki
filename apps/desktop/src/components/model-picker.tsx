...
import { getLocalModelsStatus } from '@/loki'
...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelPricing } from '@/types/loki'
...
export function ModelPickerDialog({
  ...
  // the `loki model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // Two different facts wear the same badge: `free_tier` is a signed-in WunderCorp
