 ...
 *
 * The palette-bearing skins (wundercorp, catppuccin, everforest, solarized) are forks
 ...
 *
 *   wundercorp       ← github.github-vscode-theme   (Light Default / Dark Default)
 ...
 * re-derived. `wundercorp-alt` is first-party — do not re-derive it from GitHub.
 */
...
/**
 * WunderCorp — the canonical Loki desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Loki's own: a VS Code theme carries no font opinion, and
 * these are the stacks every skin has been rendering with.
 */
/**
 * GitHub — the upstream palette, unmodified.
 *
 * `wundercorp` is a fork of this with its own accent, so shipping both keeps the
 * original available on its own terms instead of only existing as the thing
 * wundercorp diverged from. Everything but the accent family is identical between
 * them; separate presets are what let wundercorp's accent move without silently
...
/**
 * WunderCorp — the canonical Loki desktop identity: GitHub's chrome carrying WunderCorp
 ...
 */
export const wundercorpTheme: DesktopTheme = {
  name: 'wundercorp',
  label: 'WunderCorp',
  description: 'GitHub chrome, WunderCorp blue accent',
  colors: {
    background: '#ffffff',
    foreground: '#1f2328',
    card: '#f6f8fa',
...
const WUNDERCORP_ALT_BLUE = '#0053FD'
const WUNDERCORP_ALT_NAVY = '#1540B1'
const WUNDERCORP_ALT_CREAM = '#FFE6CB'

const wundercorpAltTint = (pct: number) => `color-mix(in srgb, ${WUNDERCORP_ALT_BLUE} ${pct}%, #FFFFFF)`
const wundercorpAltTintTransparent = (pct: number) => `color-mix(in srgb, ${WUNDERCORP_ALT_BLUE} ${pct}%, transparent)`

/**
 * WunderCorp Alt — the hand-authored WunderCorp from before the GitHub fork. Light is
 * glass neutrals with brand blue; dark is cream on mission-blue.
 */
export const wundercorpAltTheme: DesktopTheme = {
  name: 'wundercorp-alt',
  label: 'WunderCorp Alt',
  ...
  colors: {
    ...
    muted: wundercorpAltTint(5),
    mutedForeground: '#666678',
    popover: '#FFFFFF',
    popoverForeground: '#17171A',
    primary: WUNDERCORP_ALT_BLUE,
    primaryForeground: '#FCFCFC',
    secondary: wundercorpAltTint(7),
    secondaryForeground: '#242432',
    accent: wundercorpAltTint(10),
    accentForeground: '#202030',
    border: wundercorpAltTintTransparent(22),
    input: wundercorpAltTintTransparent(30),
    ring: WUNDERCORP_ALT_BLUE,
    midground: WUNDERCORP_ALT_BLUE,
    composerRing: WUNDERCORP_ALT_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: wundercorpAltTintTransparent(18),
    userBubble: wundercorpAltTint(6),
    userBubbleBorder: wundercorpAltTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
    foreground: WUNDERCORP_ALT_CREAM,
    card: '#12378F',
    cardForeground: WUNDERCORP_ALT_CREAM,
    muted: '#183F9A',
    mutedForeground: '#B5C7F3',
    popover: '#123A96',
    popoverForeground: WUNDERCORP_ALT_CREAM,
    primary: WUNDERCORP_ALT_CREAM,
    primaryForeground: '#0D2F86',
    secondary: '#1B45A4',
    secondaryForeground: '#E0E8FF',
    accent: WUNDERCORP_ALT_NAVY,
    accentForeground: '#F0F4FF',
    border: '#3158AD',
    input: '#0B2566',
    ring: WUNDERCORP_ALT_CREAM,
    midground: WUNDERCORP_ALT_BLUE,
    composerRing: WUNDERCORP_ALT_CREAM,
    destructive: '#C0473A',
...
export const BUILTIN_THEMES: Record<string, DesktopTheme> = {
  wundercorp: wundercorpTheme,
  github: githubTheme,
  catppuccin: catppuccinTheme,
  everforest: everforestTheme,
  solarized: solarizedTheme,
  'wundercorp-alt': wundercorpAltTheme,
...
export const DEFAULT_SKIN_NAME = 'wundercorp'
