/**
 * Loki skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$LOKI_HOME/skins/` (or a
 * built-in) resolved by `loki_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Loki authors from a prompt lights up all three surfaces from one file.
 *
...
import type { LokiSkin, SkinColors } from '@wundercorp/loki-shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: LokiSkin): DesktopTheme | null {
