...
export const SESSION_DRAFTS_STORAGE_KEY = 'loki:composer-drafts:v3'
...
/**
 * Patch one asynchrowundercorp attachment occurrence wherever the main composer owns
 ...
 *
 * Dispatched synchrowundercorply, unlike the focus bus: the flush must complete
 * before the HUD window is created.
 */
const DRAFT_SYNC_EVENT = 'loki:composer-draft-sync'
