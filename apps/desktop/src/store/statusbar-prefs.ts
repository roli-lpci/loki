...
// v1 (`loki.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'loki.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'loki.desktop.statusbarHidden'
// v1 (`loki.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'loki.desktop.statusbarVisible.v2'
