...
const POPOUT_STORAGE_KEY = 'loki.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'loki.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'loki.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'loki.desktop.composerPopout.position'
