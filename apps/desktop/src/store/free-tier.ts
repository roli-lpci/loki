...
import type { FreeTierStatus } from '@/types/loki'

/** The model the free-tier route runs on. Used to recognise a session that is
 *  still homed on the free tier after a sign-in. */
export const FREE_TIER_MODEL = 'wundercorp/welcome'

/** The provider slug the free-tier route and a signed-in WunderCorp account share. */
export const WUNDERCORP_PROVIDER_ID = 'wundercorp'
