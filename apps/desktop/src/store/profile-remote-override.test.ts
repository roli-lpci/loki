...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://loki.example.com:8443/x')).toBe('loki.example.com:8443')
    expect(remoteHostLabel('https://loki.example.com:443')).toBe('loki.example.com')
    expect(remoteHostLabel('http://loki.example.com:80')).toBe('loki.example.com')
  })
