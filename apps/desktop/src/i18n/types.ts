...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshLokiPathTitle: string
      sshLokiPathDesc: string
      sshLokiPathPlaceholder: string
    ...
    toolsets: {
      ...
      useBackend: string
      wundercorpIncluded: string
      wundercorpAuthNeededTitle: string
      wundercorpAuthNeededMessage: (provider: string) => string
      wundercorpAuthSignIn: string
      wundercorpAuthDoneTitle: string
      wundercorpAuthDoneMessage: string
      wundercorpAuthFailed: string
  ...
  commandCenter: {
    ...
    lokiActiveSessions: (version: string, count: number) => string
  ...
  freeTier: {
    /** Settings › Providers row title while the WunderCorp identity is the free tier. */
