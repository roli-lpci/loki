...
export const en: Translations = {
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Loki and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Loki.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Loki. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Loki',
    continue: 'Continue in Loki',
  ...
  boot: {
    ready: 'Loki Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Loki settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Loki backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingLokiDesktop: 'Starting Loki Desktop…'
    },
    errors: {
      backgroundExited: 'Loki background process exited.',
      backgroundExitedDuringStartup: 'Loki background process exited during startup.',
    ...
    failure: {
      ...
      cloudDownTitle: 'WunderCorp Cloud agent is down',
      cloudDownDescription:
        'The WunderCorp-managed cloud agent this gateway connects to is returning a server error. It cannot be restarted from here — check its status, switch to the local gateway, or get support.',
      cloudDownHint:
        'The buttons below open the WunderCorp Portal (instance status and controls) and our Discord for support.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Loki backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateLoki: 'Update Loki',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Loki Desktop.',
    ...
    native: {
      ...
      inputBody: 'Loki is waiting for your response.',
      turnDoneTitle: 'Loki finished',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleWunderCorp: 'Out of WunderCorp credits',
  ...
  sendDiagnostics: {
    title: 'Send diagnostics to WunderCorp',
    privacyNotice:
      'This uploads a debug bundle to WunderCorp-internal storage (not a public paste). It includes system info (OS, versions, provider, which API keys are configured — never the keys themselves) and full agent, gateway, and desktop logs (up to 512 KB each), which likely contain conversation content, tool outputs, and file paths. Secrets are redacted before upload. The bundle is viewable only by WunderCorp staff and allowlisted Discord moderators, and auto-deletes after 14 days.',
    upload: 'Upload',
    uploading: 'Uploading…',
    cancel: 'Cancel',
    close: 'Close',
    ...
    failedHint:
      'You can also run `loki debug share --wundercorp` from a terminal, or `loki debug share --local` to print the report without uploading.',
    handoffLead: 'Pick up the discussion in:',
    links: {
      github: 'GitHub Issues',
      portal: 'WunderCorp Portal Support',
      discord: 'Discord'
    }
  },
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Loki defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Loki catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Loki generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Loki picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Loki.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Loki closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Loki is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Loki asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Loki was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Loki was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Loki follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Loki can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Loki when it helps. Each tip appears once.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Loki walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Loki is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Loki, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Loki Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Loki runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Loki only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Loki',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Loki checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Loki configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Loki.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Loki gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Loki Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Loki Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Loki runtime managed by this app.',
      kindRemoteDesc: 'A Loki gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Loki Cloud account.',
      kindSshDesc: 'A Loki install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Loki manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Loki Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Loki backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset LOKI_DESKTOP_REMOTE_URL and LOKI_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Loki backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Loki backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Loki Cloud',
      cloudDesc: 'Sign in once to Loki Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Loki Cloud',
      cloudSignIn: 'Sign in to Loki Cloud',
      cloudSignedIn: 'Signed in to Loki Cloud',
      cloudNeedsSignIn: 'Sign in to Loki Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Loki Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Loki Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Loki Cloud',
      cloudSignedOutMessage: 'Cleared the Loki Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /loki.',
      ...
      restartingMessage: 'Loki Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Loki ${version}` : ''}`,
      ...
      sshDesc:
        'Loki is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshLokiPathTitle: 'Loki path (optional)',
      sshLokiPathDesc: 'Full path to the remote loki binary. Blank = auto-detect.',
      sshLokiPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Loki found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Loki runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Loki is not installed on the remote host. Install it there (curl -fsSL https://loki.computer/install.sh | sh) or set the Loki path.',
      sshErrPlatform:
        'Unsupported remote platform. Loki Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Loki on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Loki. Review the exact configuration below — it comes from the link, not from Loki.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Loki starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Loki ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Loki runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Loki at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      wundercorpIncluded: 'Included with a WunderCorp subscription — sign in to WunderCorp Portal to activate.',
      wundercorpAuthNeededTitle: 'Sign in to WunderCorp Portal',
      wundercorpAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to WunderCorp Portal.`,
      wundercorpAuthSignIn: 'Sign in',
      wundercorpAuthDoneTitle: 'WunderCorp Portal connected',
      wundercorpAuthDoneMessage: 'Your subscription backends are now active.',
      wundercorpAuthFailed: 'WunderCorp Portal sign-in did not complete',
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Loki browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via loki curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Loki to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Loki catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Loki builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Loki to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Loki to generate pets.',
      backgroundHint: 'You can close this — Loki will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Loki desktop' },
    ...
    lokiActiveSessions: (version, count) => `Loki ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Loki installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Loki creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@loki:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Loki you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Loki environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Loki did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Loki will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Loki backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Loki. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Loki backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Loki...',
    placeholderReconnecting: 'Reconnecting to Loki…',
    ...
    attachUrlDesc: 'Loki will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Loki…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Loki…',
    ...
    unsupportedMessage: 'This version of Loki can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Loki from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Loki will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Loki desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Loki updater takes over in its own window and reopens Loki automatically when it’s done. Please don’t reopen Loki yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Loki reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Loki reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Loki?',
    blockerBody:
      'Loki needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Loki',
    foreignBlockerBody:
      'Loki can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Loki can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Loki needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Loki Desktop',
    setupChoiceDesc:
      'Connect this app to a Loki gateway you already run, or install Loki locally on this computer.',
    connectExistingTitle: 'Connect to existing Loki',
    ...
    installLocalTitle: 'Install Loki locally',
    installLocalDesc: 'Download Loki, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Loki Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Loki',
    remoteSetupDesc: 'Enter your gateway URL. Loki Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Loki gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/loki',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Loki gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Loki Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Loki CLI or desktop instance is running. Stop any running Loki instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Loki Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Loki is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Loki…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Loki',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Loki at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Loki connects automatically',
    ...
    authorizeThere: 'Authorize Loki there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Loki there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    providerRowTitle: 'WunderCorp · free tier',
    providerRowPitch: 'Sign in with a WunderCorp account to unlock more models and tools.',
    readyTitle: 'Loki is ready.',
    readyCaption: 'Free · connectors included',
    begin: 'Begin',
    signInInstead: 'Sign in with a WunderCorp account instead',
    otherProviders: 'Other providers',
    stripTitle: 'Free WunderCorp inference and connectors are now available.',
    stripBody: 'Open the model picker to try them, or sign in with a WunderCorp account.',
    openModelPicker: 'Open model picker',
    dismiss: 'Dismiss',
    statusLabel: model => `WunderCorp · free tier · ${model}`,
    signIn: 'Sign in',
    signInHeading: 'Sign in with a WunderCorp account to unlock more models and tools.',
    ...
    alreadySignedInBody: 'This Loki is already signed in to a WunderCorp account.'
  },
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid WunderCorp subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Loki Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Loki Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Loki will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Loki is restarting...',
      askRestart: 'Ask Loki to restart the server',
      lookingRestart: taskId => `Loki is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Loki is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Loki to open a page.',
      finishedRestarting: message => `Loki finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Loki could not restart the server.',
      stillWorking:
        'Loki is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Loki is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Loki gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.loki/config.yaml). Loki won’t ask again for commands like this — in this session or any future one.`,
    ...
    mcpSetup: {
      ...
      catalogSource: 'From the WunderCorp-approved catalog',
  ...
  prompts: {
    ...
    sudoDesc: 'Loki needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Loki needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Loki reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Loki types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote: 'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Loki enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Loki Desktop to use Save Image.',
    restartToSaveImages: 'Restart Loki Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `loki gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Loki loads when the work calls for them.'
      },
      messaging: {
        title: 'Loki away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Loki made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Loki — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
