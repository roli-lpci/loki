 ...
 * `<loki home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'loki.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'loki.desktop.disabledPlugins.v1'
