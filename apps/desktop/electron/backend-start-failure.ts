 ...
 * startLoki() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startLoki() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startLoki`, re-emits
