...
// by main.ts (`setBackgroundThrottling` driven by the merged `loki:active-work`
...
// (the "Loki idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Loki" wake word has NO preceding click,
