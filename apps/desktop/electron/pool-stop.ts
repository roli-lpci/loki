 ...
 *    dying one on the same LOKI_HOME.
 *
...
export interface PoolStopperDeps {
  /** The live backend pool. Entries are evicted synchrowundercorply on stop. */
  pool: Map<string, PoolStopEntry>
  /** Signal the child (tree/group kill per platform). Synchrowundercorp. */
