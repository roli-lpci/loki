...
// even though a fresh shell — and the Loki CLI — sees it immediately. The
// desktop's LOKI_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\loki. Reading
