 ...
 *
 * A public install can end up with `origin=git@github.com:wundercorp/loki.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/wundercorp/loki.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/wundercorp/loki-agent'
