 ...
 * Apps) login to a gated Loki gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (WunderCorp Portal) issues a per-gateway-instance client_id and only
...
// loki_cli/web_server.py status handler.
