// The WunderCorp free tier is gated by ONE launch-time decision. The Python backend
// reads LOKI_GUEST_ONBOARDING and treats exactly "1" as on; the desktop
...
export const GUEST_ONBOARDING_ENV = 'LOKI_GUEST_ONBOARDING'
