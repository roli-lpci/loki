...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @wundercorp/loki-plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@wundercorp/loki-shared'],
              message: 'Plugins import only @wundercorp/loki-plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
