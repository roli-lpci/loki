...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Loki session"),
        ...
        _cmd("status", "Show Loki session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Loki agent"),
        ...
        _cmd("update", "Update Loki Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Loki gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Loki session in it",
