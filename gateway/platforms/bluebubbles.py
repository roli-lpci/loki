...
# `require_mention: true` without custom aliases uses Loki wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?loki\s+agent\b[,:\-]?", r"(?<![\w@])@?loki\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Loki defaults)."""
