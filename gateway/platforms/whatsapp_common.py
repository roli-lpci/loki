...
class WhatsAppBehaviorMixin:
    ...
    DEFAULT_REPLY_PREFIX: str = "⚕ *Loki Agent*\n────────────\n"
...
def resolve_whatsapp_bridge_dir() -> Path:
    ...
    try:
        ...
        pass
    if loki_home_bridge.exists():
        return loki_home_bridge
    try:
        loki_home_bridge.parent.mkdir(parents=True, exist_ok=True)
        shutil.copytree(install_bridge, loki_home_bridge, dirs_exist_ok=False)
        return loki_home_bridge
    except Exception:
        return install_bridge
